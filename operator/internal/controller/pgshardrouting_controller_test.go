...
var _ = Describe("PgShardRouting compilation", func() {
	...
	makeShard := func(cluster, name, start, end string, serving bool, role pgshardv1alpha1.ShardRole, pod string) {
	...
	It("compiles routing with endpoints and bumps epochs monotonically", func() {
		...
		makeShard("rc1", "rc1-a", "", "80", true, pgshardv1alpha1.ShardRoleData, "rc1-p0")
		makeShard("rc1", "rc1-b", "80", "", true, pgshardv1alpha1.ShardRoleData, "rc1-p1")
	...
	It("keeps the last good routing when a compile fails", func() {
		...
		makeShard("rc2", "rc2-a", "", "80", true, pgshardv1alpha1.ShardRoleData, "rc2-p0")
		makeShard("rc2", "rc2-b", "80", "", true, pgshardv1alpha1.ShardRoleData, "rc2-p1")
		reconcile("rc2")
	...
	It("emits and withdraws a cutover gate from a CuttingOver reshard", func() {
		...
		makeShard("rc3", "rc3-a", "", "80", true, pgshardv1alpha1.ShardRoleData, "rc3-p0")
		makeShard("rc3", "rc3-b", "80", "", true, pgshardv1alpha1.ShardRoleData, "rc3-p1")
		reconcile("rc3")
